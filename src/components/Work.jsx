  ...
  const work = [
    {
      ...
      demo: 'https://dho-construcciones.vercel.app/',
    },
    {
      name: 'Construcciones y Edificaciones Arroyo SAC',
      icon: './assets/web2.png',
      description: 'Diseño Web',
      demo: 'https://inversiones-arroyo-sac.vercel.app/',
    },
    {
      name: 'A&A Ingenieria y Proyectos SAC',
      icon: './assets/web3.png',
      description: 'Diseño Web',
      demo: 'https://a-a-ingenieria-y-proyectos-sac.vercel.app/',

    },
    {
      name: 'Dental Smile',
      icon: './assets/web4.png',
      description: 'Diseño de interfaz',
      demo: 'https://web-dental-nine.vercel.app/',
    },

    {
      name: 'Calculadora JS',
      icon: '/assets/web5.png',
      description: 'Diseño de interfaz',
      demo: 'https://web-building-sage.vercel.app/views/presupuesto.html',
    }
  ];
