...
export default function About() {
  const data = [
    ...
    },
    {
      ...
      description:
        " Formación continua en desarrollo web a través de Davante Master D  y otros recursos en línea.",
    },
    {
      name: "Proyectos",
      icon: <FolderCode className="w-7 h-7 text-[#2563eb]" />,
      description:
        "He desarrollado más de 5 proyectos web con enfoque empresarial.",
    },
  ];
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="max-w-max mx-auto relative">
          <img
            ...
            alt="JanCarlos Jesus Arroyo Vargas"
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl text-[#1f2937]/80 dark:text-gray-300">
            ...
            Actualmente desarrollo proyectos orientados a inteligencia artificial, procesamiento multimedia y arquitecturas escalables, incluyendo “TraslaAIte”, 
